% 2025 students' five training and testing
close all
clear
% Get the training data filepaths
I=dir("Five Training\s*.wav");
...
M=200;
% MFCC bins produced. 30 is sufficient for the 23/23 speakers in the
% training/testing datasets/provides the desired 100% accuracy.
K=30;
