% Default training data and notch-filtered testing data
close all
clear
% Get the training data filepaths
I=dir("Training_Data\s*.wav");
...
% Apply notch filter to test data
notchFilterData('Test_Data', 'Filtered_Test_Data', 60, 30);
